...
[![x-cmd/install — gistui Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gistui.svg?lang=zh)](https://x-cmd.com/install/gistui)
...
合计: **31,985** 行代码（覆盖前 5 种语言、共 **73** 个文件）。
...
- **发布数**: 26 · **已合并 PR**: 290 · **开放 PR**: 0 · **已关闭 issue**: 164 · **开放 issue**: 0 · **提交数**: 780
...
_数据快照: `data/card/260923.yml` · 2026-09-23T06:19:01Z._
